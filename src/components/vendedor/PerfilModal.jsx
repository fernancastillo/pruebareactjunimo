                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body">
                            {/* Campos NO editables - RUN y Tipo */}
                            <div className="row mb-4">
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label fw-bold text-dark">RUN</label>
                                        <div className="form-control bg-light">
                                            <strong>{usuario.run}</strong>
                                        </div>
                                        <div className="form-text">
                                            El RUN no se puede modificar
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label fw-bold text-dark">Tipo de Usuario</label>
                                        <div className="form-control bg-light">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label fw-bold text-dark">Región</label>
                                        <select
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label fw-bold text-dark">Comuna</label>
                                        <select
                            ...
                            <div className="mb-3">
                                <label className="form-label fw-bold text-dark">Fecha de Nacimiento</label>
                                <input
                                    type="date"
                            ...
                            <h6 className="fw-bold mb-3 text-dark">Cambiar Contraseña (Opcional)</h6>
                            ...
                            <div className="mb-3">
                                <label className="form-label fw-bold text-dark">Confirmar Contraseña</label>
                                <div className="input-group">
                                    <input
